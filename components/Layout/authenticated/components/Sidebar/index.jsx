...
const Sidebar = ({ sidebarOpen, setSidebarOpen, session }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 text-white flex-col overflow-y-hidden bg-[#1c2434] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-center my-2 gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/manage">{session?.user?.name}</Link>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/manages/provider" ||
                  pathname.includes("manages/provider")
                }
              >
                {(handleClick, open) => {
                  return (
                      ...
                      <Link
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/manage/providers" ||
                            pathname.includes("manage/providers")) &&
                          "bg-graydark dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          ...
                          <li>
                            <Link
                              ...
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
                                pathname.endsWith("manage/providers/add")
                                  ? "text-white"
                                  : "text-slate-400"
                              }`}
                            >
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
                                pathname.endsWith("manage/providers")
                                  ? "text-white"
                                  : "text-slate-400"
                              }`}
                            >
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-slate-400 duration-300 ease-in-out hover:text-white ${
